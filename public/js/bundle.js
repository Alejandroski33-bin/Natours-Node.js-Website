(() => {
    ...
    "public/js/leaflet.js"() {
      displayMap = (locations) => {
        ...
        L.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png", {
          attribution: '&copy; <a href="https://tiles.basemaps.cartocdn.com/vector/carto.streets">CARTO</a> contributors'
        }).addTo(map);
  ...
  var DEFAULT_CHUNK_SIZE, isFunction2, encodeUTF82, decodeURIComponentSafe, test, maybeWithAuthCredentials, factory, seedCache, getFetch, adapter;
